 ...
 * `{ keyId, privateKeyPem }`, built from a test key generated by the same
 * offline ceremony as production. Keep it OUTSIDE this repo — no private key
 * is ever committed here, test keys included (see the README).
 *
